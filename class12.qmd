...
format:
  revealjs: 
    ...
    preview-links: auto
    date-format: iso
    footer: "431 Class 12 | 2026-10-01 | <https://thomaselove.github.io/431-2026/>"
---
...
source("c12/data/Love-431.R") # for twobytwo() function
...
```{r}
#| echo: true
nicu <- read_excel("c12/data/nicu_seq.xls") |>
  janitor::clean_names()
...
## Visual Abstract: NICU Sequencing

![](c12/images/NICU_abstract.png)
...
- How do outcome probabilities differ by exposure?
...
## `twobytwo` from `Love-431.R` script
...
## 2x2 Table: Bayesian Augmentation
